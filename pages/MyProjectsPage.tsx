...
return (  
  ...
  >  
    {idea.title}  
  </h3>    <p className="text-sm font-poppins text-purple-600 mt-1">  
    {idea.tagline}  
  </p>  
</div>  
                        </div>  
                ...
                </div>  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-t border-[var(--border-primary)] pt-4 gap-4">  
