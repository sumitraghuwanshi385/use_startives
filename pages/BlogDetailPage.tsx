...
import { ChevronLeft, Share2, Timer, ArrowRight, Star, Users, Award } from "lucide-react";
  ...
  "1": {
    ...
    content: (
      <>
        ...
        <p>
          Even with every framework in place, disagreements will still happen. That's not a sign your partnership is broken, it's a sign you're building something real with another human being who has their own instincts and blind spots. The difference between founder pairs who survive these moments and pairs who don't usually comes down to process, not personality. Startives founders who navigate conflict well tend to separate the person from the position. Instead of arguing about who's right, they ask what evidence would change either person's mind, and they agree in advance on who has final say when a decision genuinely can't wait for consensus.
        </p>
        <p>
          It also helps enormously to bring in outside perspective before a disagreement calcifies into resentment. A trusted advisor, a mentor from the Startives community, or even a structured mediation session can surface the actual issue underneath a surface-level argument about a feature or a hire. Founders rarely fight about the thing they think they're fighting about. A debate over a marketing budget is often really a debate about whether both people still trust the other's judgment, and naming that directly tends to resolve things faster than another round of arguing the original topic.
        </p>
        </div>
        ...
        <p>
          The most common mistake isn't skipping these frameworks entirely, it's setting them up once and never revisiting them. A RACI matrix from month one becomes useless by month twelve if the company has pivoted twice and hired five people since then. Treat every framework in this guide as a living document, not a one-time exercise you can check off a list and forget about.
        </p>
        <p>
          The second mistake is letting one founder own the framework while the other merely agrees to it passively. Equity splits, operating agreements, and vision workshops only work when both founders actively participate in shaping them. A framework imposed by one founder onto another, even a fair one, tends to breed quiet resentment that surfaces months later at the worst possible time, usually during a fundraising process or a major hiring decision when the company can least afford internal friction.
        </p>
        </div>
  ...
  "2": {
    ...
    content: (
      <>
        ...
        <p>
          The single biggest mistake founders make on any fundraising profile, Startives included, is treating it as a resume instead of a pitch. A resume lists what you've done. A pitch makes an investor feel the size of the opportunity in front of them. Founders who simply list job titles and responsibilities without framing them around outcomes lose an investor's attention within seconds, long before the investor ever gets to the metrics that would have impressed them.
        </p>
        <p>
          The second mistake is inconsistency between your Startives profile and everything else an investor will check. If your profile claims strong retention but your public analytics dashboard tells a different story, or if your team page lists a co-founder who quietly left the company months ago, that inconsistency erodes trust instantly and permanently. Investors talk to each other, and a reputation for exaggeration spreads through a fund's network far faster than founders realize.
        </p>
        </div>
        ...
        <p>
          A profile update isn't just a maintenance task, it's a legitimate reason to re-engage investors who previously passed or went quiet. Startives founders who ship a meaningful update, a new logo, a strong growth month, a notable hire, tend to pair that update with a short, direct follow-up message to investors already in their pipeline. This works because it gives the investor new information to react to, rather than asking them to reconsider a decision they've already made with no new data.
        </p>
        <p>
          The founders who raise fastest on Startives treat their profile and their outreach as two halves of the same motion. The profile does the passive work of attracting inbound interest around the clock, while timed, metric-driven outreach does the active work of nudging warm leads toward a first call. Neither one works particularly well alone.
        </p>
        </div>
  ...
  "3": {
    ...
    content: (
      <>
        ...
        <p>
          It's worth being honest about what an algorithm can and can't do. Startives' matching system is excellent at narrowing a pool of thousands of builders down to a shortlist of people worth talking to. It cannot tell you whether you'll actually enjoy spending sixty-hour weeks with someone, whether your senses of humor mesh, or whether you'll both stay calm during the same kind of crisis. That part still requires real conversations, ideally several of them, spread across a few weeks rather than compressed into a single coffee meeting.
        </p>
        <p>
          The founders who report the best long-term outcomes on Startives treat the algorithm as a filter, not a verdict. They use it to skip the wasted early conversations with people who were never going to be a fit on paper, then spend their saved time going deeper with the small number of matches who actually clear that bar. Quantity of conversations goes down. Quality goes up considerably.
        </p>
        </div>
        ...
        <p>
          If you're new to the platform, resist the temptation to fill out your profile quickly just to start browsing matches. The quality of what the algorithm can surface for you is directly proportional to the honesty and completeness of what you put in. Spend real time on the sections covering your working style, your risk tolerance, and your actual availability, not just your technical skills. These softer signals are frequently what separate a founding team that survives its first hard year from one that doesn't.
        </p>
        <p>
  ...
  "4": {
    ...
    content: (
      <>
        ...
        <p>
          Two signals get misread more often than any others on early-stage teams. The first is press coverage. A nice write-up feels like validation, but it's a distribution event, not a product signal, and the spike in signups it generates almost never reflects sustained demand. Founders who treat a press bump as proof of fit tend to over-invest in the wrong lessons for months afterward.
        </p>
        <p>
          The second is founder-led sales. If you personally close every early customer through sheer charm and persistence, that's a real accomplishment, but it isn't yet evidence the product sells itself. The true test comes when someone other than you tries to sell it, or when a user discovers it without any hand-holding from the founding team. Startives builders who wait for that unassisted signal before scaling avoid a painful, expensive correction later.
        </p>
        </div>
        ...
        <p>
          You don't need an expensive analytics stack in the early days, but you do need discipline about what you track. A simple cohort retention chart, updated weekly, will tell you more truth about your product than a dashboard full of vanity metrics. Pair it with a lightweight feedback loop, a single form or a shared channel where users can flag friction directly, and review both every week without fail.
        </p>
        <p>
  ...
  "5": {
    ...
    content: (
      <>
        ...
        <p>
          The biggest barrier to building in public isn't strategy, it's the fear of looking unpolished. Founders wait for a milestone worth sharing and end up sharing nothing for months. The better approach, and the one most consistently rewarded inside the Startives community, is to share process rather than perfection. A screenshot of a rough new feature, a short note about a decision you're wrestling with, a graph of a metric moving in the right direction, none of it needs to be a polished announcement to be valuable.
        </p>
        <p>
          Consistency matters more than production quality. A founder who posts a short, honest update every week for six months builds more trust and more audience than one who occasionally posts a beautifully produced update once a quarter. The former looks like a founder in motion. The latter, however good the individual post, can start to look like a founder hiding between updates.
        </p>
        </div>
  ...
  "6": {
    ...
    content: (
      <>
        ...
        <p>
          The most common mistake is applying too late, treating non-dilutive capital as a backup plan only when a priced round falls through. Grant cycles and lender underwriting both move slowly, often taking two to four months from application to funded, so founders who wait until they're desperate rarely get the timeline they need. The founders who use this capital most effectively on Startives start researching options a full quarter before they'll actually need the funds.
        </p>
        <p>
          The second mistake is applying for the wrong type of capital for your stage. A pre-revenue company applying for revenue-based financing will simply get rejected, wasting weeks of effort that could have gone toward a grant application better suited to an earlier stage. Match the capital type to your actual metrics honestly before investing time in an application.
        </p>
        </div>
        ...
        <p>
          Non-dilutive capital works best as a complement woven into your broader fundraising calendar, not a replacement for it. Plan grant applications around your product roadmap, since many programs want to see a specific R&amp;D milestone tied to the funds requested. Plan venture debt around your equity raises, since lenders will always look at your most recent round and investor syndicate as core underwriting signals.
        </p>
        <p>
  ...
  "7": {
    ...
    content: (
      <>
        ...
        <p>
          The most common pitfall is scope creep disguised as ambition. A solo founder who starts adding features to appeal to a slightly different audience segment ends up with a diluted product that serves nobody particularly well. The Micro-SaaS builders who actually hit ten thousand dollars in MRR on schedule are almost always the ones who said no to good ideas that weren't the idea they committed to at month one.
        </p>
        <p>
          The second pitfall is neglecting support as the user base grows. Early users forgive rough edges because they can reach a real human quickly. As volume increases, response times slip, and churn creeps up quietly before the founder notices the pattern in the data. Building a simple support workflow, even a basic help center and a fast email response commitment, earlier than feels necessary pays for itself many times over.
        </p>
        </div>
  ...
  "8": {
    ...
    content: (
      <>
        ...
        <p>
          Agents that can take actions, calling APIs, writing to databases, sending messages on a user's behalf, introduce a class of risk that a purely conversational chatbot never had. Prompt injection through untrusted content, whether from a webpage the agent reads or a document a user uploads, is one of the most underestimated threats in production agent systems today. Treat any content the agent didn't generate itself as untrusted input, and constrain what actions an agent can take based on that content without an explicit confirmation step.
        </p>
        <p>
          The teams building the most trustworthy agent products on Startives apply the principle of least privilege rigorously: an agent handling customer support shouldn't have the same database permissions as one handling internal analytics, even if a single, more powerful agent would technically be simpler to build. The extra architectural discipline pays for itself the first time it prevents a scoped mistake from becoming a much larger incident.
        </p>
        </div>
