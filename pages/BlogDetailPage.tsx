...
interface BlogPost {
  ...
  updatedAt: string;
  readTime?: string; // fallback; calculated dynamically
  author: string;
  image: string;
  imageWidth: number;
  imageHeight: number;
...
/* -------------------------------------------------------------------------- */
/* Reusable UI pieces (UI preserved exactly)                                  */
/* -------------------------------------------------------------------------- */
...
const StepHeading = ({
  ...
  <div className="mt-12 mb-4" id={id}>
    <span
    ...
    <h2 className="!mt-0" id={id}>
      {title}:
    </h2>
  </div>
);

const HighlightHeading = ({ title, id }: { title: string; id?: string }) => (
  <h2 className="!mb-5 pl-4 border-l-4 border-blue-500/50" id={id}>
    {title}:
  </h2>
);

/* -------------------------------------------------------------------------- */
/* Blog data – keyed by slug                                                  */
/* -------------------------------------------------------------------------- */

const blogData: Record<string, BlogPost> = {
  "co-founder-equity-frameworks": {
    ...
    date: "JUL 10, 2026",
    datePublished: "2026-07-10T09:00:00+00:00",
    updatedAt: "2026-07-12T14:30:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "Five proven frameworks that help tech co-founders keep equity fair, vision aligned, and the partnership healthy before tension appears.",
    keywords: [
      "co-founder equity",
    ...
    content: (
      <>
        <p className="lead mb-6">
          One of the biggest reasons startups fail isn't technology. It isn't funding. It isn't competition.{" "}
          <strong>It's founder misalignment.</strong>
        </p>
        <p className="lead mb-6">
          Every year, thousands of promising startups collapse because co-founders disagree over ownership, responsibilities, product direction, and where the company is even headed. On{" "}
          <Link to="/" className="text-blue-500 hover:underline">Startives</Link>, we see this pattern come up again and again in founder matching conversations: two brilliant people, one broken agreement.
        </p>

        <p className="lead mb-6">
          Building a startup in 2026 moves fast, with constant iteration and AI doing more of the heavy lifting than ever. Teaming up with a tech{" "}
          <Link to="/blog/co-founder-matching-algorithms" className="text-blue-500 hover:underline">co-founder</Link> is basically a professional marriage, and that marriage gets tested hard the moment real money, real users, or a real disagreement shows up.
        </p>
        <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={1} title="Adopt a Dynamic Equity Split Framework" id="dynamic-equity-split" />
          <p className="lead mb-6">
            ...
            <ul className="space-y-3 list-none pl-0 m-0">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  <strong className="text-[var(--text-primary)]">Time Commitment:</strong> Full-time vs part-time contributions tracked weekly, not assumed.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  <strong className="text-[var(--text-primary)]">Technical Impact:</strong> Code commits, architecture decisions, and MVP delivery speed.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  <strong className="text-[var(--text-primary)]">Network &amp; Capital Value:</strong> Introductions to VCs, early customers, and strategic partners.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  <strong className="text-[var(--text-primary)]">Opportunity Cost:</strong> Salary given up and personal runway put into the company.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12">
          <StepHeading number={2} title="Implement the RACI Responsibility Matrix" id="raci-matrix" />
          <p className="lead mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
            ...
            <div className="bg-[var(--background-primary)] p-5 rounded-2xl border border-[var(--border-primary)]">
              <h4 className="font-bold mb-2 flex items-center gap-2">
                <Star className="w-4 h-4 text-emerald-500" /> COO / Growth
              </h4>
          ...
          <p>This one habit is one of the biggest predictors of speed among high-performing teams on Startives.</p>
        </div>

        <div className="mt-12">
          <StepHeading number={3} title="Draft a Comprehensive Founder Operating Agreement" id="founder-operating-agreement" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={4} title="Run Quarterly Vision Alignment Workshops" id="vision-alignment" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={5} title="Build in Public as a Team" id="build-in-public" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <h2 id="disagreements">What Happens When Disagreements Show Up Anyway</h2>
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={6} title="Common Mistakes Founders Make with These Frameworks" id="common-mistakes" />
          <p className="lead mb-6">
  ...
  "optimize-startup-profile-attract-vcs": {
    ...
    updatedAt: "2026-07-08T11:20:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "Turn your Startives profile into a living pitch deck that stops investors mid-scroll and drives inbound interest from premium VCs.",
    keywords: [
      "startup profile",
      "VC fundraising",
      "investor outreach",
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <StepHeading number={1} title="Craft a Magnetic Headline & One-Liner" id="magnetic-headline" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={2} title="Showcase Traction with Real Metrics" id="traction-metrics" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={3} title="Build a Compelling Builder Story" id="builder-story" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={4} title="Optimize for Search & Discovery" id="search-discovery" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={5} title="Leverage Social Proof & Testimonials" id="social-proof" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Common Profile Mistakes That Quietly Kill Interest" id="profile-mistakes" />
          <p className="lead mb-6">
          ...
          <p>Investors talk to each other, and a reputation for exaggeration spreads through a fund's network faster than founders realize.</p>
        </div>

        <div className="mt-12">
          <HighlightHeading title="Timing Your Outreach Around Profile Updates" id="timing-outreach" />
          <p className="lead mb-6">
          ...
          <p>Neither one works particularly well on its own.</p>
        </div>
  ...
  "co-founder-matching-algorithms": {
    ...
    date: "JUN 28, 2026",
    datePublished: "2026-06-28T09:00:00+00:00",
    updatedAt: "2026-06-30T16:45:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "How modern matching algorithms score skill complementarity, work style, values and ambition to surface co-founders worth talking to.",
    keywords: [
      "co-founder matching",
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <HighlightHeading title="How Matching Algorithms Work in 2026" id="how-matching-works" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <div className="not-prose my-8 p-6 rounded-2xl bg-[var(--component-background)] border border-[var(--border-primary)]">
            <h2 className="text-2xl md:text-3xl font-black text-[var(--text-primary)] mb-4" id="key-factors">
              Key Factors Scored:
            </h2>
            <ul className="space-y-3 list-none pl-0 m-0">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Technical complementarity, so you avoid duplicate skill sets that leave gaps uncovered.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Work style compatibility, measured through structured assessments rather than a single conversation.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Geographic and time-zone flexibility, since async collaboration friction quietly kills more startups than founders admit.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Shared values and long-term ambition level. Bootstrapper energy paired with venture-scale ambition rarely ends well.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12">
          <HighlightHeading title="Why Data-Driven Matching Beats Random Networking" id="data-driven-vs-networking" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="The Human Element Behind the Data" id="human-element" />
          <p className="lead mb-6">
          ...
          <p>Fewer conversations, but much better ones.</p>
        </div>

        <div className="mt-12">
          <HighlightHeading title="Getting Started on Startives" id="getting-started" />
          <p>
        ...
        <div className="mt-12">
          <HighlightHeading title="What This Means for Your Search" id="what-this-means" />
          <p>
  ...
  "product-market-fit-early-stage": {
    ...
    date: "JUN 15, 2026",
    datePublished: "2026-06-15T09:00:00+00:00",
    updatedAt: "2026-06-18T10:15:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "A practical playbook for early-stage developers to reach product-market fit through fast MVPs, disciplined user interviews, and data-driven iteration.",
    keywords: [
      "product-market fit",
      "PMF",
      "early stage startup",
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <StepHeading number={1} title="Build Fast, Measure Faster" id="build-fast-measure-faster" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={2} title="Talk to 100 Users Before Scaling" id="talk-to-users" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={3} title="Iterate with Data, Not Opinions" id="iterate-with-data" />
          <p className="lead mb-6">
          ...
          <p className="lead mb-6">Getting attached to a feature is one of the quietest ways teams stall out just short of fit.</p>
          <p>
        ...
        <div className="mt-12">
          <StepHeading number={4} title="Watch for the Signals That Actually Matter" id="signals-that-matter" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={5} title="Don't Scale What Isn't Working" id="dont-scale-early" />
          <p>
        ...
        <div className="mt-12">
          <HighlightHeading title="Common Signals Founders Misread" id="signals-misread" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Tools That Help You Measure Honestly" id="measurement-tools" />
          <p className="lead mb-6">
  ...
  "building-in-public-open-builders": {
    ...
    date: "MAY 30, 2026",
    datePublished: "2026-05-30T09:00:00+00:00",
    updatedAt: "2026-06-02T13:40:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "Why building in public beats stealth mode in 2026: faster feedback, stronger trust, better talent, and organic distribution that compounds.",
    keywords: [
      "building in public",
      "open builders",
      "stealth mode",
    ...
    content: (
      <>
        ...
        <p className="lead mb-6">On Startives, the data behind this shift is hard to ignore.</p>
        ...
        <div className="mt-12">
          <div className="not-prose p-6 rounded-2xl bg-[var(--component-background)] border border-[var(--border-primary)]">
            <h2 className="text-2xl md:text-3xl font-black text-[var(--text-primary)] mb-4" id="benefits-building-public">
            ...
            <ul className="space-y-3 list-none pl-0 m-0">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Organic user acquisition through transparency, since your build process itself becomes a form of marketing.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Early feedback loops that stop you from wasting effort on features nobody actually wants.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
                <span className="text-[var(--text-secondary)] leading-relaxed">
                  Attracting co-founders and talent naturally, since people can watch your judgment and consistency over time before ever applying.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12">
          <StepHeading number={1} title="Trust Is the New Moat" id="trust-moat" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={2} title="The Talent & Investor Flywheel" id="talent-investor-flywheel" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={3} title="How to Start Building in Public Without Overthinking It" id="start-building-public" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <StepHeading number={4} title="Balancing Openness with Strategic Discretion" id="balancing-openness" />
          <p className="lead mb-6">
  ...
  "non-dilutive-funding-grants-venture-debt": {
    ...
    date: "MAY 14, 2026",
    datePublished: "2026-05-14T09:00:00+00:00",
    updatedAt: "2026-05-16T15:10:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "How SaaS founders can stack grants, revenue-based financing and venture debt to extend runway while keeping their cap tables clean.",
    keywords: [
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <HighlightHeading title="Government Grants for Deep Tech and R&D" id="government-grants" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Revenue-Based Financing" id="revenue-based-financing" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Specialized Venture Debt for AI/SaaS" id="venture-debt" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Stacking Multiple Non-Dilutive Sources" id="stacking-sources" />
          <p>
        ...
        <div className="mt-12">
          <HighlightHeading title="Common Mistakes When Applying for Non-Dilutive Capital" id="common-mistakes-funding" />
          <p className="lead mb-6">
          ...
          <p>Match the capital type to your actual metrics honestly before spending time on an application.</p>
        </div>

        <div className="mt-12">
          <HighlightHeading title="Timing Considerations Across Your Fundraising Calendar" id="timing-considerations" />
          <p className="lead mb-6">
  ...
  "micro-saas-blueprint-10k-mrr": {
    ...
    date: "APR 22, 2026",
    datePublished: "2026-04-22T09:00:00+00:00",
    ...
    imageHeight: 675,
    excerpt:
      "A six-month playbook for solopreneurs to go from idea to $10K MRR with a narrow Micro-SaaS product, lean stack, and compounding distribution.",
    keywords: [
      "Micro-SaaS",
      "solopreneur",
      "10k MRR",
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <HighlightHeading title="Month 1-2: Find a Painfully Specific Problem" id="find-problem" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Month 2-3: Lean Architecture & Automation" id="lean-architecture" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Month 3-4: Distribution Loops That Compound" id="distribution-loops" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Month 4-5: Pricing for Sustainability" id="pricing" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Month 5-6: Retention Over Acquisition" id="retention" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Common Pitfalls That Derail Solo Founders" id="common-pitfalls" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="A Lean Tool Stack That Actually Scales" id="lean-tool-stack" />
          <p className="lead mb-6">
  ...
  "scalable-ai-agents-architecture": {
    ...
    updatedAt: "2026-03-12T17:25:00+00:00",
    author: "Startives Editorial Team",
    image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=1200&q=80",
    imageWidth: 1200,
    imageHeight: 675,
    excerpt:
      "Production-ready patterns for AI agents: context caching, semantic routing, hybrid search, multi-agent orchestration, cost guardrails and security.",
    keywords: [
      "AI agents",
      "agent architecture",
    ...
    content: (
      <>
        ...
        <div className="mt-12">
          <h2 id="context-caching">Context Window Caching and Semantic Routing</h2>
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <h2 id="vector-hybrid-search">Vector Database Optimization with Hybrid Search</h2>
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Multi-Agent Orchestration Frameworks" id="multi-agent" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Observability and Cost Guardrails" id="observability" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Designing for Graceful Degradation" id="graceful-degradation" />
          <p>
        ...
        <div className="mt-12">
          <HighlightHeading title="Testing and Evaluation Pipelines for Agents" id="testing-evaluation" />
          <p className="lead mb-6">
        ...
        <div className="mt-12">
          <HighlightHeading title="Security Considerations for Agent Systems" id="security" />
          <p className="lead mb-6">
...
/* Ordered list for prev/next + related */
const blogOrder = Object.keys(blogData);

/* -------------------------------------------------------------------------- */
/* Utilities                                                                  */
/* -------------------------------------------------------------------------- */

const calculateReadingTime = (node: React.ReactNode): string => {
  const getText = (n: React.ReactNode): string => {
    if (typeof n === "string" || typeof n === "number") return String(n);
    if (Array.isArray(n)) return n.map(getText).join(" ");
    if (React.isValidElement(n) && n.props?.children) return getText(n.props.children);
    return "";
  };
...
const Toast = memo(({ message, visible }: { message: string; visible: boolean }) => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] px-5 py-3 rounded-full
        bg-[var(--component-background)]/90 backdrop-blur-2xl border border-white/15
        shadow-[0_8px_32px_-8px_rgba(0,0,0,0.35)] text-sm font-medium text-[var(--text-primary)]
        flex items-center gap-2 animate-in fade-in slide-in-from-bottom-4 duration-300"
    >
...
const ReadingProgressBar = memo(() => {
  ...
  return (
    ...
    >
      <div
        className="h-full bg-gradient-to-r from-red-500 to-blue-500 transition-[width] duration-150 ease-out"
      ...
      <>
        ...
        <div className="lg:hidden mb-8">
          <button
            ...
            className="flex items-center justify-between w-full px-4 py-3 rounded-2xl
              bg-[var(--component-background)] border border-[var(--border-primary)]
          ...
          {open && (
            <nav id="toc-mobile" className="mt-2 p-4 rounded-2xl bg-[var(--component-background)] border border-[var(--border-primary)]">
        ...
        <aside className="hidden lg:block sticky top-24 self-start w-56 shrink-0">
          <nav
            ...
            className="p-4 rounded-2xl bg-[var(--component-background)]/70 backdrop-blur-2xl border border-white/15
              shadow-[inset_0_1px_0_0_rgba(255,255,255,0.35),0_4px_14px_-6px_rgba(0,0,0,0.18)]"
          >
            <p className="text-[10px] font-bold uppercase tracking-wider text-blue-500 mb-3 flex items-center gap-1.5">
              ...
              {items.map((item) => (
                <li key={item.id}>
                  <button
                    type="button"
                    onClick={() => scrollTo(item.id)}
                    className={`text-left text-xs leading-snug w-full py-0.5 transition-colors border-l-2 pl-3 ${
                      activeId === item.id
                        ? "border-blue-500 text-blue-500 font-semibold"
                        : "border-transparent text-[var(--text-muted)] hover:text-blue-500 hover:border-blue-500/40"
                    }`}
                  >
                    {item.text}
                  </button>
...
const RelatedCard = memo(({ post }: { post: BlogPost }) => {
  const rt = useMemo(() => calculateReadingTime(post.content), [post.content]);
  return (
    <Link
      to={`/blog/${post.slug}`}
      className="group flex flex-col rounded-2xl overflow-hidden bg-[var(--component-background)] border border-[var(--border-primary)]
        hover:border-blue-500/40 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 no-underline"
    >
      <img
        src={post.image}
        alt={post.title}
      ...
      <div className="p-4 flex flex-col flex-1">
        <span className="text-[10px] font-bold uppercase tracking-wider text-blue-500 mb-1.5">
          {post.category}
        </span>
        <h4 className="font-bold text-sm text-[var(--text-primary)] leading-snug line-clamp-2 group-hover:text-blue-500 transition-colors mb-2">
          {post.title}
        </h4>
        <p className="text-xs text-[var(--text-muted)] line-clamp-2 mb-3 flex-1">{post.excerpt}</p>
...
const BlogDetailPage = () => {
  ...
  const readingTime = useMemo(
    () => (blog ? calculateReadingTime(blog.content) : "5 min read"),
    [blog]
  );

  // Auto-generate TOC from H2s after render
  useEffect(() => {
  ...
  const related = useMemo(() => {
    if (!blog) return [];
    const others = blogOrder
      .filter((s) => s !== blog.slug)
      .map((s) => blogData[s]);

    const score = (p: BlogPost) => {
      let s = 0;
      if (p.category === blog.category) s += 3;
      const overlap = p.keywords.filter((k) => blog.keywords.includes(k)).length;
      s += overlap;
      return s;
    };
  ...
  const { prev, next } = useMemo(() => {
    ...
    const idx = blogOrder.indexOf(blog.slug);
    return {
      prev: idx > 0 ? blogData[blogOrder[idx - 1]] : null,
      next: idx < blogOrder.length - 1 ? blogData[blogOrder[idx + 1]] : null,
    };
  }, [blog]);

  // Canonical & SEO
  const canonical = blog ? `https://startives.com/blog/${blog.slug}` : "https://startives.com/blog";
  const siteName = "Startives";
  ...
  const articleSchema = useMemo(() => {
    ...
    return {
      ...
      publisher: {
        ...
        logo: {
          "@type": "ImageObject",
          url: "https://startives.com/logo.png",
        },
      },
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://startives.com",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Blog",
          item: "https://startives.com/blog",
        },
        {
          "@type": "ListItem",
          position: 3,
  ...
  if (!blog) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--background-secondary)] text-[var(--text-primary)]">
        <Helmet>
          <title>Article Not Found | Startives Blog</title>
          <meta name="robots" content="noindex, follow" />
        </Helmet>
        <div className="text-center px-4">
          <h1 className="text-6xl font-black mb-4">404</h1>
          <p className="text-[var(--text-secondary)] mb-2 text-lg">This article could not be found.</p>
          <p className="text-sm text-[var(--text-muted)] mb-8">
            It may have been moved or the URL is incorrect.
          </p>
          <Link
            to="/blog"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-red-500 to-blue-500 text-white font-bold text-sm hover:brightness-110 transition-all"
          >
  ...
  return (
    <div className="bg-[var(--background-secondary)] min-h-screen transition-colors duration-300">
      <Helmet>
        <title>{blog.title} | Startives Blog</title>
      ...
      >
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-[var(--text-muted)]">
            <li>
              <Link to="/" className="hover:text-blue-500 transition-colors inline-flex items-center gap-1">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-[var(--text-secondary)] font-medium line-clamp-1 max-w-[240px]" aria-current="page">
              {blog.title}
            </li>
          </ol>
        </nav>
        ...
        <header>
          ...
          <h1
            className="text-4xl md:text-6xl font-black text-[var(--text-primary)] leading-[1.1] mb-5"
            itemProp="headline"
          >
            {blog.title}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6 pb-6 border-b border-[var(--border-primary)]">
            ...
            <time
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 h-7 bg-[var(--component-background)] border border-[var(--border-primary)] rounded-full text-xs text-[var(--text-muted)]"
        ...
        <figure className="mb-12">
          <img
            ...
            decoding="async"
            fetchPriority="high"
            className="w-full aspect-video object-cover rounded-3xl shadow-2xl border border-[var(--border-primary)]"
            itemProp="image"
          />
        </figure>
        ...
        >
          {prev ? (
            <Link
              to={`/blog/${prev.slug}`}
              className="group flex flex-col p-5 rounded-2xl bg-[var(--component-background)] border border-[var(--border-primary)]
                hover:border-blue-500/40 transition-all no-underline"
            >
              <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)] mb-1.5 flex items-center gap-1">
                <ChevronLeft className="w-3 h-3" /> Previous
              </span>
              <span className="font-bold text-sm text-[var(--text-primary)] group-hover:text-blue-500 transition-colors line-clamp-2">
                {prev.title}
              </span>
            </Link>
          ) : (
          ...
          {next ? (
            <Link
              to={`/blog/${next.slug}`}
              className="group flex flex-col p-5 rounded-2xl bg-[var(--component-background)] border border-[var(--border-primary)]
                hover:border-blue-500/40 transition-all no-underline sm:text-right"
            >
              <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)] mb-1.5 flex items-center gap-1 sm:justify-end">
        ...
        {related.length > 0 && (
          <section className="mt-16" aria-labelledby="continue-reading">
            <h3 id="continue-reading" className="text-2xl font-black text-[var(--text-primary)] mb-6">
              Continue Reading
            </h3>
