...
export const NotificationDropdown: React.FC = () => {
  ...
  const handleNavigate = (path: string, id: string) => {
    markNotificationAsRead?.(id); // backend patch call hona chahiye
    navigate(path, { state: { highlightId: id } });
  };

  return (
    <div className="absolute right-2 top-14 w-[360px] max-w-[95vw] bg-[var(--component-background)] border border-[var(--border-primary)] rounded-2xl shadow-2xl z-50">
